...
from bup.lib.bup import git, metadata
from helpers import *
from bup.lib.bup.git import BUP_NORMAL, BUP_CHUNKED, cp
...
class File(Node):
    """A normal file from bup.lib.bup.lib.s repository."""
...
_symrefs = 0
class Symlink(File):
    """A symbolic link from bup.lib.bup.lib.s repository."""
