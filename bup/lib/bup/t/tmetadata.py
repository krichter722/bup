...
from bup.lib.bup import git, metadata, vfs
from bup.lib.bup.helpers import clear_errors, detect_fakeroot, is_superuser, resolve_parent
from wvtest import *
...
from bup.lib.bup.lib.metadata import posix1e
if not posix1e:
    @wvtest
...
from bup.lib.bup.lib.metadata import xattr
if xattr:
    @wvtest
